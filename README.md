...
- 22 directly injected scripts/modules;
- one hidden, read-only Phase 3A Status Board shadow observer.

The 22-entry direct manifest is the permanent runtime ceiling after the 22 Sep 2026 repository audit. Transitive ES-module imports are audited separately and may not be used to hide runtime growth outside that ceiling.
