...
> **Historical planning snapshot.** Retained for continuity and decision history. It is not the current runtime authority after the 22 Sep 2026 full-repository audit. Current ownership/runtime truth is maintained in `docs/ACTIVE_RUNTIME_STACK.md`, `docs/build-2/ACTIVE_RUNTIME_BUDGET.json`, and `docs/FULL_REPO_AUDIT_2026-09-22.md`.
