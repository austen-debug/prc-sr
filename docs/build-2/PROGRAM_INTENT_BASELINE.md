...
Runtime status: Build 1 remains operational; Build 2 remains staged
...
Write-heavy migration remains blocked until stale-write conflict protection and required audit behavior are available.
