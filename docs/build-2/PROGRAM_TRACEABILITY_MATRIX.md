...
Status: FOUNDATION COMPLETE / PHASE 3A SHADOW ACTIVE  
...
| Last arrival is derived | `domain/arrivals.mjs`, canonical Status Board snapshot | Gates A, F, and Phase 3A mismatch fixture | Hidden shadow active | Disposition of Build 1 `last_airport` versus derived arrival |
...
| Capability-driven six-posture composition | responsive foundation plus Status Board route contract | responsive, Gate F, and Phase 3A fixture | Automated route contract complete | Manual six-posture captures |
...
| Status Board-first migration order | program baseline | Gate F and Phase 3A governance suites | In execution | Complete Status Board route gate before Processing |
...
|---:|---|---|
| 1 | Status Board | sustained shadow parity, mismatch disposition, timer/fullscreen, stale/offline, manual accessibility, activation and rollback |
