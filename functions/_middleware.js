...
const UI_STYLESHEETS = [
  '<link rel="stylesheet" href="/css/military-glass-terminal.css?v=military-glass-terminal-20260922-squadron-sitrep1">'
];
...
const UI_HEAD_SCRIPTS = [
  ...
  '<script src="/js/prc-dash-final-audit.js?v=squadron-sitrep-20260921" defer></script>',
